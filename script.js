...
function getPasswordOptions() {
  ...
  charLen = prompt("Please enter the length of the password between 8-128")

  if (charLen < 8 || charLen > 128) {
    alert("Password length must be between 8 and 128 characters - click GENERATE PASSWORD AGAIN");
    return;
  }
  else {
